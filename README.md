# EdgeML_26
The repository includes the template code and instructions for the second project of the course Edge Computing for ML, 2026 at ÅA. Each file serves as follows:
...
- EdgeML26.ipynb (incomplete): Includes data loading, processing and model architecture. Should be used for compression experiments.
